...
//    }
     ...
     */
    private static final byte INHERIT_ORIENTATION_FROM_SCENE_MASK = 4;
    ...
    final void nodeResolvedOrientationInvalidated() {
        ...
        if (isInheritOrientationFromScene(oldResolvedNodeOrientation)) {
            resolvedNodeOrientation |= INHERIT_ORIENTATION_FROM_SCENE_MASK;
        }
    ...
    private static boolean isInheritOrientationFromScene(byte resolvedNodeOrientation) {
        return (resolvedNodeOrientation & INHERIT_ORIENTATION_FROM_SCENE_MASK) != 0;
    }
